...
GRID_LINE        = (40,  55,  80)
EMPTY_CELL       = (30,  42,  60)
START_COLOUR     = (16,  185, 129)  
GOAL_COLOUR      = (59,  130, 246)  
WALL_COLOUR      = (31,  41,  55)   
FRONTIER_COLOUR  = (245, 158, 11)   
VISITED_COLOUR   = (239, 68,  68)  
PATH_COLOUR      = (34,  197, 94)  
...
if __name__ == "__main__":
    rows, cols, density = run_setup_screen()   
    app = App(rows, cols, density)              
    app.run()
